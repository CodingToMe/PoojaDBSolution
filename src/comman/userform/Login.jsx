      ...
      <section className="vh-100">
        <div className="container py-5 h-100">
          <div className="row d-flex align-items-center justify-content-center h-100">
            ...
            <div className="col-md-7 col-lg-5 col-xl-5 offset-xl-1 p-3 card " style={{ textAlign: "left" }} >
              <h5 className='text-center mb-3 mt-3'>Login Now</h5>
              <form onSubmit={formData}>
                {/* <!-- Email input --> */}
                <div className="form-outline mb-3 ">
                  <label className="form-label " for="form1Example13">Email </label>
                  <input type="tel" id="form1Example13" className="form-control form-control-lg"
                    required
                    name='email'
                    value={email || ''}
                    onChange={(e) => setEmail(e.target.value)}
                  />
                  {/* <span className="error">Please enter a valid </span> */}
                </div>
